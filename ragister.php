					...
					<div class="row">
						<div class="col-lg-12">
							...
							<form id="register-form" action="" method="post" role="form" style="display: none;">
								...
								<div class="form-group">
									<input type="tel" name="mobile" minlength="11" id="password" tabindex="2" class="form-control" placeholder="Mobile" required pattern="^\d{11}$">
								</div>
								<div class="form-group">
									<input type="password" minlength="8" name="password" id="confirm-password" tabindex="2" class="form-control" placeholder="Password" required>
								</div>
								<div class="form-group">
									<div class="row">
										<div class="col-sm-6 col-sm-offset-3">
