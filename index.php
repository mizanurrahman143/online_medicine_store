...
<head>
    ...
    <title>Online Medicine Store || OMS</title>
...
<body>
                            ...
                            <!-- <div class="col-lg-4">
                                ...
                                <div class="form-group ">
                                    <select class="form-control" name="category">
                                        ...
                                        <option value="PRESMEDICINE">PRESCRIPTION MEDICINE</option>
    ...
    <section class="dorne-features-destinations-area">
        <div class="container-fluid">
            ...
            <h4 style="background-color:red;color:white;text-align:center">OTC MEDICINES</h4>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="features-slides owl-carousel">
                        ...
                        <?php
                        $result = select("select * from items where category='OTCMEDICINE'");
            ...
            <h4 style="background-color:red;color:white;text-align:center">COVID-19 SPECIAL</h4>
...
<div class="row">
    <div class="col-12">
        <div class="features-slides owl-carousel">
            ...
            <?php
            $result = select("select * from items where category='COVID19SPECIAL'");
            while ($r = mysqli_fetch_array($result)) {
                extract($r);
            ?>
                <div class="single-features-area">
            ...
            <h4 style="background-color:red;color:white;text-align:center">PRESCRIPTION MEDICINES</h4>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="features-slides owl-carousel">
                        ...
                        <?php
                        $result = select("select * from items where category='PRESMEDICINE'");
                        while ($r = mysqli_fetch_array($result)) {
                            extract($r);
                        ?>
                            <div class="single-features-area">
            ...
            <h4 style="background-color:red;color:white;text-align:center">HOMEOPATHY</h4>
            ...
            <h4 style="background-color:red;color:white;text-align:center">VITAMINS & SUPPLEMENTS</h4>
                ...
                <div class="col-12">
                    <div class="features-slides owl-carousel">
                        ...
                        while ($r = mysqli_fetch_array($result)) {
                            extract($r);
                        ?>
                            <a href="view_detail.php?id=<?= $elecid ?>">
                                <div class="single-features-area">
            ...
            <h4 style="background-color:red;color:white;text-align:center">AYURVEDA</h4>
            ...
            <h4 style="background-color:red;color:white;text-align:center">HEALTH FOOD & DRINKS</h4>
            ...
            <h4 style="background-color:red;color:white;text-align:center">HEALTHCARE DEVICES</h4>
            ...
            <h4 style="background-color:red;color:white;text-align:center">SKINCARE</h4>
                ...
                <div class="col-12 d-md-flex align-items-center justify-content-between">
                    <div class="footer-text">
                        <h5>
                            ...
                            This site is Develop by || TEAM OMS ||
                        </h5>
