								...
								<div class="form-body">
									<form class="form-horizontal" action="myphp.php" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<div class="col-xs-8">
												<select class="form-control" name="category">
													...
													<option value="COVID19SPECIAL">COVID-19 SPECIAL</option>
													<option value="PRESMEDICINE">PRESCREPTION MEDICINE</option>
										...
										<div class="form-group">
											...
											<div class="col-xs-8">
												<textarea name="discription" class="form-control col-xs-6"></textarea>
											</div>
										</div>
										<div class="col-xs-12">
											<center><input type="submit" class="btn btn-info" name="elect_submit" id="elec_submit" value="SUBMIT"></center>
										</div>
									</form>
								</div>
							</div>
